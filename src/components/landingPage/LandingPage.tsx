                    ...
                    <div className="flex flex-col items-center gap-12 lg:flex-row">
                        <div className="lg:w-5/12">
                            ...
                            <p className="mb-8 text-lg text-slate-600">
                                The ultimate job board and application tracker
                                all in one beautiful dashboard. Discover
                                opportunities, apply with ease, and never lose
                                track of your applications again.
                            </p>
                ...
                <div className="mx-auto max-w-6xl">
                    <div className="mb-16 text-center">
                        ...
                        <p className="mx-auto max-w-2xl text-lg text-slate-600">
                            Our platform combines job discovery with application
                            tracking to streamline your job search process.
                        </p>
                    </div>
            ...
            <section className="bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-20">
                <div className="mx-auto max-w-6xl text-center">
                    ...
                    <p className="mx-auto mb-8 max-w-2xl text-xl text-indigo-100">
                        ...
                        job search process with our platform.
                    </p>
            ...
            <section className="bg-white px-4 py-20">
                <div className="mx-auto max-w-6xl">
                    <div className="mb-16 text-center">
                        ...
                        <p className="mx-auto max-w-2xl text-lg text-slate-600">
                            Hear from job seekers who have found success using
                            our platform
                        </p>
                    </div>
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        {[
                            {
                                quote: 'This tool helped me organize my job search and land my dream role at a tech startup.',
                                name: 'Alex Johnson',
                                title: 'Software Engineer',
                            },
                            {
                                quote: 'The ability to track application status across different companies was a game-changer for me.',
                                name: 'Sarah Williams',
                                title: 'Marketing Manager',
                            },
                            {
                                quote: "I discovered jobs I wouldn't have found otherwise, thanks to the aggregation feature.",
                                name: 'Michael Chen',
                                title: 'Data Analyst',
                            },
