                    ...
                    {jobTypeOptions.map((option) => (
                        ...
                        >
                            <Checkbox
                                ...
                                onCheckedChange={() =>
                                    toggleFilter('jobType', option.value)
                                }
                            />
                    ...
                    {salaryRanges.map((option) => (
                        ...
                        >
                            <Checkbox
                                ...
                                onCheckedChange={() =>
                                    toggleFilter('salary', option.value)
                                }
                            />
                            <Label htmlFor={`salary-${option.value}`}>
                                {option.label}
                            </Label>
                        </div>
                    ))}
                    ...
                    {industryOptions.map((option) => (
                        ...
                        >
                            <Checkbox
                                ...
                                onCheckedChange={() =>
                                    toggleFilter('industry', option.value)
                                }
                            />
                            <Label htmlFor={`industry-${option.value}`}>
                                {option.label}
                            </Label>
                        </div>
                    ))}
