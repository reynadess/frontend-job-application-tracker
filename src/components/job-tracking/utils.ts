...
export function sortApplications(applications: ApplicationsType[], sort: JobTableSort): ApplicationsType[] {
...
export function paginateData<T>(data: T[], currentPage: number, rowsPerPage: number): T[] {
