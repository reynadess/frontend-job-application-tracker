import { z } from 'zod';
import { DegreeType, EmploymentType, FieldOfStudyType, WorkMode } from '../enum/enums';
...
export const projectSchema = z.object({
    ...
    projectGithub: z
        ...
        .refine((url) => url.startsWith('https://github.com/'), {
            message:
                'URL must be a GitHub link starting with "https://github.com/"',
        }),
    stack: z.enum([
        'GO',
        'PYTHON',
...
export const profileSchema = z.object({
    ...
    twitterLink: z
        ...
        .refine((url) => url === '' || url.startsWith('https://x.com/'), {
            message:
                'URL must be a Twitter link starting with "https://x.com/"',
        }),
    discordLink: z
        .string()
        .refine(
            (url) => url === '' || url.startsWith('https://discordapp.com/'),
            {
                message:
